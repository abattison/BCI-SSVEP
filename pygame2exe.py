...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "bci_game.py"
 
        #Name of program
        self.project_name = "BCI Targeting Game"
        ...
        #Auhor of program
        self.author_name = "Thomas Fuller"
        self.author_email = "fullert@lafayette.edu"
        self.copyright = "Copyright (c) 2014 Thomas Fuller."
 
        #Description
        self.project_description = "A BCI targeting game for use in the Lafayette BCI research Lab."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "bci_game.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["ka1.ttf", "bci_game.jpg"]
