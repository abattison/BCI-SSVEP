...
record_freq = "both"  # valid options are 8, 15, "both" ("both" should not be used for training)
...
if record_freq == 8 or record_freq == "both":
    bars.append(Bar(top_bar, 16))
if record_freq == 15 or record_freq == "both":
    bars.append(Bar(bot_bar, 30))
...
def main():
    ...
    ann.create_from_file("ssvep.net")
